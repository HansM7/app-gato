          ...
          <div className="w-full md:col-span-2 col-span-5  p-8 flex flex-col gap-8">
            ...
            >
              <img
                ...
                alt="Servicio de Marketing Digital para Flowers Travel- Aumenta tu presencia en línea y maximiza tus ventas"
                title="Servicio de Marketing Digital para Flowers Travel"
