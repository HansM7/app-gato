  ...
  const cardContents = [
    {
      ...
      imgSrc:
        "https://i.pinimg.com/736x/ec/de/11/ecde11eababbe763d898171c4dddbad8.jpg",
    ...
    },
    {
      ...
      imgSrc:
        "https://i.pinimg.com/736x/dd/76/87/dd76870ad6c21dd95434fec00cee79db.jpg",
  ...
  const cardContents2 = [
    {
      ...
      description: prueba,
      imgSrc:
        "https://www.freshbooks.com/wp-content/uploads/2021/10/what-is-teamwork.jpg",
      svgPath: `<svg width="100%" height="100%" viewBox="0 0 45 40" fill="none" xmlns="http://www.w3.org/2000/svg">
