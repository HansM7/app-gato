...
function Navigation({
  ...
  return (
    <>
      {isMdOrLarger && (
        <div className=" w-[92px] flex   left-0 top-0   flex-col justify-between min-h-svh bg-white items-center shadow-lg border-r">
                ...
                <Modal.Content>
                  <Typography variant="div" className="!mb-6">
                    ...
                    >
                      ...
                      en el boton siguiente e inicia una conversación con
                      nosotros
                    </Typography>
                  </Typography>
                </Modal.Content>
