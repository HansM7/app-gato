    ...
    <div className="fixed bottom-6 right-6 z-20">
     {/*  <div className="absolute w-full sm:w-[400px] max-w-[400px] bg-white shadow-2xl ">
        ...
        <div>
          <div>
            <p>
              Hola <hr /> Gracias por visitar nuestra pagina <hr /> ¿En que
              podemos ayudarte?
            </p>
          </div>
          <button>
      ...
      <div
        role="button"
        className="  bg-green-500 p-2 w-[60px] h-[60px] flex justify-center items-center rounded-[50%] group hover:bg-green-700 transition-all duration-700"
        onClick={redirect}
      >
        <svg
        ...
        <div className="hidden absolute right-[calc(60px+18px)] px-3 py-1 bg-white text-black rounded-2xl whitespace-nowrap drop-shadow-md group-hover:block">
