...
function BannerServices() {
  return (
    <section className="md:min-h-screen min-h-[28rem]    flex bg-gray-100  relative">
      <div className=" md:min-h-screen md:max-h-screen overflow-hidden min-h-[28rem] absolute">
        <img
          // autoPlay
          // muted
          // loop
          className="w-screen md:min-h-screen min-h-[28rem] object-cover  overflow-hidden filter brightness-50"
