export const DataMarketing = [
  ...
  {
    name: "plan Inicial",
    descriptionCorta: "Tu esencia, nuestro diseño",
    details: [
      {
        name: "8 piezas gráficas estratégicas",
        items: [
          "Se trabajará dos diseños para que el cliente escoja el diseño que se publicará.",
          "Las redes sociales que se manejaran son Facebook, Instagram y LinkedIn, se publicará el mismo post adaptado a cada plataforma.",
        ],
      },
      {
        name: "1 Reel cada dos semanas",
        items: [
      ...
      },
      {
        ...
        items: [
          "3 campañas de ADS de interacción o mensajes en Facebook e Instagram",
  ...
  {
    name: "plan Integral",
    descriptionCorta: "Destaca en cada contacto con tus clientes.",
    details: [
      {
      ...
      },
      {
        ...
        items: [
          "Para Lima moderna: 1 sesión cada mes de 20 fotos y 4 videos",
          "Para provincia-zonas alejadas: 1 sesión trimestral de 60 fotos y 12 videos por sesión. ",
  ...
  },
  {
    ...
    details: [
      ...
      {
        name: "Comunnity manager (Part Time)",
        items: [
          "Creación y programación de contenido en redes sociales",
          "Atención de comentarios y mensajes de clientes potenciales     (se notificará y traspasará la comunicación al agente de ventas de la marca)",
        ],
  ...
  },
  {
    ...
    details: [
      ...
      {
        name: "16 Reel cada mes",
        items: [
          "16 ediciones de videos tipo reel que se pueden replicar tanto en Facebook, Instagram y Tiktok.",
          "Presentación: Duración máxima de 30 segundos.",
        ],
      },
      {
      ...
      {
        name: "Comunnity manager (Full Time)",
        items: [
          "Creación y programación de contenido en redes sociales",
          "Atención de comentarios y mensajes de clientes potenciales (se notificará y traspasará la comunicación al agente de ventas de la marca)",
        ],
  ...
  },
  {
    ...
    descriptionCorta: "Lima moderna",
    details: [
      {
        name: "Sesión Fotográfica Profesional",
        items: [
          "Detalles del servicio: Disfruta de una sesión que incluye 40 fotografías de alta calidad. ",
          "Nota: No se incluye transporte. Consulta por opciones adicionales y recomendaciones.",
        ],
      },
      {
        name: "Sesión de video",
        items: [
          "Detalles del servicio: Producción de 8 videos cortos.",
          "Duración máxima por video: 1 minuto, optimizado para captar la atención y transmitir mensajes clave de manera efectiva.",
  ...
  {
    name: "SESIÓN DE FOTOS Y VIDEOS ",
    descriptionCorta: "Provincias - Zonas alejadas",
    details: [
      {
        name: "Sesión Fotográfica Profesional",
        items: [
